    ...
    <div>
      ...
      <Paper style={{ padding: '20px', marginBottom: '20px' }}>
        ...
        <TextField
          ...
          onChange={(e: React.ChangeEvent<HTMLInputElement>) => setNewConnector({ ...newConnector, id: e.target.value })}
          fullWidth
          sx={{ mb: 1 }}
        />
        <TextField
          ...
          onChange={(e: React.ChangeEvent<HTMLInputElement>) => setNewConnector({ ...newConnector, name: e.target.value })}
          fullWidth
          sx={{ mb: 1 }}
        />
        <TextField
          ...
          onChange={(e: React.ChangeEvent<HTMLInputElement>) => setNewConnector({ ...newConnector, type: e.target.value })}
          fullWidth
          sx={{ mb: 1 }}
        />
        <TextField
